...
<body class="page-template">
    <div class="container">
        ...
        <header class="main-header">
            ...
            <nav class="main-nav">
                <ul>
                	<li><a href="${pageContext.request.contextPath}/admin" class="<%= currentPage.endsWith("admin_dashboard.jsp") ? "active" : "" %>">Home</a></li>
            ...
            <div class="user-menu">
                <div class="user-info">
                    <span>Admin</span>
                    <a href="#">
					    <img src="${pageContext.request.contextPath}/resources/images/system/user_icon.png" alt="User Icon" class="avatar">
					</a>
                ...
                <div class="admin-sections">
                    ...
                    <section class="admin-section" id="quick-actions">
                        ...
                        <div class="quick-actions-grid">
                        	<a href="${pageContext.request.contextPath}/registerDoctor" class="quick-action-card full-width <%= currentPage.endsWith("register_doctor.jsp") ? "active" : "" %>">
                            ...
                            <a href="${pageContext.request.contextPath}/register" class="quick-action-card full-width <%= currentPage.endsWith("register_patient.jsp") ? "active" : "" %>">
                                <div class="quick-action-icon">
