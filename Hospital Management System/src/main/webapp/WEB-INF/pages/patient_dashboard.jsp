...
<%@ page import="com.coursework.model.DoctorModel" %>
...
<body class="page-template">
    <div class="container">
        ...
        <header class="main-header">
            ...
            <nav class="main-nav">
                <ul>
                	<li><a href="${pageContext.request.contextPath}/patient" class="<%= currentPage.endsWith("patient_dashboard.jsp") ? "active" : "" %>">Home</a></li>
            ...
            <div class="user-menu">
                <div class="user-info">
                    ...
                    <img src="${pageContext.request.contextPath}../Resources/images/system/user_icon.jpg" alt="" class="avatar">
                    
                    <!-- <img src="../resources/images/system/user_icon.jpg" alt="" class="avatar"> -->
                </div>
                ...
                <section class="welcome-section">
                    ...
                    <div class="quick-actions">
						<button class="btn btn-primary"
						        onclick="window.location.href='${pageContext.request.contextPath}/appointment'">
                        ...
                        <div class="feature-card">
                            ...
                            <div class="search-doctors">
                                ...
                                <div class="doctors-list">
                                    <%
                                    List<DoctorModel> doctorList = (List<DoctorModel>) request.getAttribute("doctorList");
                                    ...
                                    %>
                                        <div class="doctor-card">
                                        	<img src="<%= request.getContextPath() %>../Resources/images/system/doctorimg.jpg" alt="<%= doc.getDoctorName() %>" class="doctor-avatar">
                                        	
                                            <!-- <a href=""><img src="/placeholder.svg?height=80&width=80" alt="<%= doc.getDoctorName() %>" class="doctor-avatar"></a> -->
                                            <div class="doctor-info">
                                                <h4><%= doc.getDoctorName() %></h4>
                                                <p><%= doc.getSpecialty() %></p>
