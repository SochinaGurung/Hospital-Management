...
public class HomeService {
	...
	public Boolean loginUser(PatientModel patientModel, DoctorModel doctorModel  ) {
	...
	private boolean validatePassword(ResultSet result, PatientModel patientModel) throws SQLException {
